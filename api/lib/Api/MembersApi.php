...
class MembersApi
{
     ...
     * @param  \OpenAPI\Client\Model\Role|null $role Return only members with this role. (optional)
     ...
     * @param  string $org_id The id of the organization. (required)
     * @param  string $token_id The id of an org access token. (required)
     * @param  \OpenAPI\Client\Model\UpdateAccessToken $update_access_token Access token details (required)
