...
class BackupsApi
{
     ...
     * @param  \OpenAPI\Client\Model\BackupOptions|null $backup_options backup_options (optional)
     ...
     * @param  string $website_id The id of the website. (required)
     * @param  bool|null $include_emails The boolean flag used to include emails in the backup. (optional, default to false)
     * @param  \OpenAPI\Client\Model\BackupOptions|null $backup_options (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['backupWebsite'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     * @param  \OpenAPI\Client\Model\BackupStorageKind|null $storage_kind The storage kind of the requested backup. (optional)
    ...
    /**
     * Operation downloadWebsiteBackup
     *
     * Download website backup
     *
     * @param  string $website_id The id of the website. (required)
     * @param  \OpenAPI\Client\Model\BackupDownloadKind|null $backup_download_kind backup_download_kind (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['downloadWebsiteBackup'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \SplFileObject
     */
    public function downloadWebsiteBackup($website_id, $backup_download_kind = null, string $contentType = self::contentTypes['downloadWebsiteBackup'][0])
    {
        list($response) = $this->downloadWebsiteBackupWithHttpInfo($website_id, $backup_download_kind, $contentType);
        return $response;
    }

    /**
     * Operation downloadWebsiteBackupWithHttpInfo
     *
     * Download website backup
     *
     * @param  string $website_id The id of the website. (required)
     * @param  \OpenAPI\Client\Model\BackupDownloadKind|null $backup_download_kind (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['downloadWebsiteBackup'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     */
    public function downloadWebsiteBackupWithHttpInfo($website_id, $backup_download_kind = null, string $contentType = self::contentTypes['downloadWebsiteBackup'][0])
    {
        $request = $this->downloadWebsiteBackupRequest($website_id, $backup_download_kind, $contentType);
    ...
    /**
     * Operation downloadWebsiteBackupAsync
     *
     * Download website backup
     *
     * @param  string $website_id The id of the website. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function downloadWebsiteBackupAsync($website_id, $backup_download_kind = null, string $contentType = self::contentTypes['downloadWebsiteBackup'][0])
    {
        return $this->downloadWebsiteBackupAsyncWithHttpInfo($website_id, $backup_download_kind, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation downloadWebsiteBackupAsyncWithHttpInfo
     *
     * Download website backup
     *
     * @param  string $website_id The id of the website. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function downloadWebsiteBackupAsyncWithHttpInfo($website_id, $backup_download_kind = null, string $contentType = self::contentTypes['downloadWebsiteBackup'][0])
    {
    ...
    /**
     * Create request for operation 'downloadWebsiteBackup'
     *
     * @param  string $website_id The id of the website. (required)
     * @param  \OpenAPI\Client\Model\BackupDownloadKind|null $backup_download_kind (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['downloadWebsiteBackup'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function downloadWebsiteBackupRequest($website_id, $backup_download_kind = null, string $contentType = self::contentTypes['downloadWebsiteBackup'][0])
    {

        // verify the required parameter 'website_id' is set
        if ($website_id === null || (is_array($website_id) && count($website_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $website_id when calling downloadWebsiteBackup'
            );
        }



        $resourcePath = '/websites/{website_id}/backup/download';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // query params
        $queryParams = array_merge($queryParams, ObjectSerializer::toQueryValue(
            $backup_download_kind,
            'backupDownloadKind', // param base name
            'BackupDownloadKind', // openApiType
            'form', // style
            true, // explode
            false // required
        ) ?? []);
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\RestoreDetailed
     */
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\RestoreDetailed, HTTP status code, HTTP response headers (array of strings)
     */
    public function getWebsiteRestoreStatusWithHttpInfo($org_id, $website_id, $backup_id, string $contentType = self::contentTypes['getWebsiteRestoreStatus'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\OpenAPI\Client\Model\RestoreDetailed',
                        $request,
                        $response,
                    );
            }
    ...
    {
        $returnType = '\OpenAPI\Client\Model\RestoreDetailed';
        $request = $this->getWebsiteRestoreStatusRequest($org_id, $website_id, $backup_id, $contentType);
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array<string,\OpenAPI\Client\Model\GlobalWebsiteBackup[]>
     */
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of array<string,\OpenAPI\Client\Model\GlobalWebsiteBackup[]>, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    {
        $returnType = 'array<string,\OpenAPI\Client\Model\GlobalWebsiteBackup[]>';
        $request = $this->listGlobalBackupsRequest($show_existing, $contentType);
     ...
     * @param  int $backup_id The id of the backup. (required)
     * @param  \OpenAPI\Client\Model\BackupStorageKind|null $storage_kind The storage kind of the requested backup. (optional)
     * @param  \OpenAPI\Client\Model\BackupRestoreOptions|null $backup_restore_options The options used to define what will be restored from the backup snapshot. (optional)
