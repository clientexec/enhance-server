...
class DomainsApi
{
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\AuthNsResponse
     */
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\AuthNsResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getDomainAuthNsWithHttpInfo($org_id, $domain_id, string $contentType = self::contentTypes['getDomainAuthNs'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\OpenAPI\Client\Model\AuthNsResponse',
                        $request,
                        $response,
                    );
            }
    ...
    {
        $returnType = '\OpenAPI\Client\Model\AuthNsResponse';
        $request = $this->getDomainAuthNsRequest($org_id, $domain_id, $contentType);
