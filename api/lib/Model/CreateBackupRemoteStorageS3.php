...
class CreateBackupRemoteStorageS3 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'purpose' => '\OpenAPI\Client\Model\RemoteStoragePurpose',
        'region' => 'string',
        'endpoint' => 'string',
        'bucket' => 'string',
    ...
    */
     ...
     * Gets purpose
     *
     * @return \OpenAPI\Client\Model\RemoteStoragePurpose
     */
     ...
     * Sets purpose
     *
     * @param \OpenAPI\Client\Model\RemoteStoragePurpose $purpose purpose
     *
     * @return self
     */
